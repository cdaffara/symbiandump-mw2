...
// Logging directory should be revised when it will be better defined how 
// It is possible that logging file
// will have to be moved under application private directory
