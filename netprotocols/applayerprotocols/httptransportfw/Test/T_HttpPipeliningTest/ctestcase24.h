...
#ifndef __CTESTCASE24_H__
#define __CTESTCASE24_H__
...
*/
class CTestCase24 : public CPipeliningTestCase
	{
public:
	static CTestCase24* NewL(CHTTPTestUtils& aTestUtils);
	~CTestCase24();
	
private:
	CTestCase24(CHTTPTestUtils& aTestUtils);
	void ConstructL();
