...
#ifndef __CINC037440_H__
#define __CINC037440_H__
...
*/
class CINC037440 : public CPipeliningTestCase
	{
public:
	static CINC037440* NewL(CHTTPTestUtils& aTestUtils);
	~CINC037440();
	
private:
	CINC037440(CHTTPTestUtils& aTestUtils);
	void ConstructL();
