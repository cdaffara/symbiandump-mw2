...
#ifndef __CTESTCASE23_H__
#define __CTESTCASE23_H__
...
*/
class CTestCase23 : public CPipeliningTestCase
	{
public:
	static CTestCase23* NewL(CHTTPTestUtils& aTestUtils);
	~CTestCase23();
	
private:
	CTestCase23(CHTTPTestUtils& aTestUtils);
	void ConstructL();
