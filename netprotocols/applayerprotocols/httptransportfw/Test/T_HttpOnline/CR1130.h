...
#ifndef	__T_CR1130_H__
#define	__T_CR1130_H__
...
*/
class CR1130: public CHttpTestTransBase, 
							public MHTTPTransactionCallback, 
							public MHTTPFilterCreationCallback
						
	{
public:
	static CR1130* NewL(TInt aTestNumber, CScriptFile* aIniSettingsFile);
	virtual ~CR1130();
...
protected:
	CR1130(TInt aTestNumber, CScriptFile* aIniSettingsFile);
