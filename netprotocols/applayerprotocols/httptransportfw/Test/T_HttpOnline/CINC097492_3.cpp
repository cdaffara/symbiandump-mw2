...
//
// Description:
// defines test class: CINC097492_3
// 
//
...
_LIT8(KHttpUrl2,		"http://10.29.23.12/manual/images/index.gif");
...
*/
CINC097492_3* CINC097492_3::NewL(TInt aTestNumber, CScriptFile* aIniSettingsFile)
	{
	CINC097492_3* self = new(ELeave)CINC097492_3(aTestNumber, aIniSettingsFile);
...
/**
	...
	@param aIniSettingsFile	- The script file that holds the sections
							  from which the value has to be retrieved
*/
CINC097492_3::CINC097492_3(TInt aTestNumber, CScriptFile* aIniSettingsFile) :
...
*/
TInt CINC097492_3::RunError(TInt aErr)
	{
	iEngine->Utils().LogIt(_L("\nTest failed with error code %d\n"), aErr);
	return KErrNone;
	}

void CINC097492_3::DoCancel()
	{
	}

const TDesC& CINC097492_3::TestName()
	{
	_LIT(KHeaderTestName,"CINC097492_3");
	return KHeaderTestName;
	}

TInt CINC097492_3::MHFRunError(TInt aError, RHTTPTransaction aTransaction, const THTTPEvent& /*aEvent*/)
	{
...
void CINC097492_3::ConfigureSessionFiltersL(TFilterConfigurationIterator* /*aFilterConfigIter*/)
	{
	if (iTestNumber == 11)
		{
		User::Leave(KErrNone);
