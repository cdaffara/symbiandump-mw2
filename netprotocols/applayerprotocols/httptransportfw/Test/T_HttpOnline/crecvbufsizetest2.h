...
#ifndef	__CRECVBUFSIZETEST2_H__
#define	__CRECVBUFSIZETEST2_H__
...
class CRecvBufSizeTest2: public CHttpTestTransBase, public MHTTPTransactionCallback
						
	{
public:
	static CRecvBufSizeTest2* NewL(TInt aTestNumber, 
	CScriptFile* aIniSettingsFile);
	virtual ~CRecvBufSizeTest2();
...
protected:
	CRecvBufSizeTest2(TInt aTestNumber, CScriptFile* aIniSettingsFile);
