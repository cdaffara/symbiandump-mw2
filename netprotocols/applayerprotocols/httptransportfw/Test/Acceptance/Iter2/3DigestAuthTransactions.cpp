...
*/
const TDesC& C3DigestAuthTransactions::TestName()
	{
	_LIT(KHeaderTestName, "Digest Authentication Test, sending three transactions");
	return KHeaderTestName;
	}

C3DigestAuthTransactions::C3DigestAuthTransactions(CScriptFile* aIniSettingsFile)
...
*/
void C3DigestAuthTransactions::OpenTestSessionL()
	{
...
*/
void C3DigestAuthTransactions::CloseTestSession()
	{
...
/**
	...
	@leave		Leaves with a standard error.
*/
void C3DigestAuthTransactions::DoRunL()
	{
	OpenTestSessionL(); 
...
void C3DigestAuthTransactions::OpenTestTrans1L()
	{
	// Literals used in the function
	_LIT8(KUrlPath,				"/http_tests/digest/auth/");
...
void C3DigestAuthTransactions::OpenTestTrans2L()
	{
	// Literals used in the function
	_LIT8(KUrlPath,				"/http_tests/digest/rfc2069/");
...
void C3DigestAuthTransactions::OpenTestTrans3L()
	{
	// Literals used in the function
	_LIT8(KUrlPath,				"/http_tests/digest/rfc2069/");
...
TInt C3DigestAuthTransactions::MHFRunError(TInt aError, RHTTPTransaction /*aTransaction*/,
...
void C3DigestAuthTransactions::MHFRunL(RHTTPTransaction aTransaction,
									   const THTTPEvent& aEvent)
	{
...
TBool C3DigestAuthTransactions::GetCredentialsL(const TUriC8& /*aURI*/, RString aRealm, RStringF /*aAuthenticationType*/, RString& aUsername, RString& aPassword)
	{
	if (!iSetCredentials)
		return EFalse;
