...
CHttpTestCasePost23::CHttpTestCasePost23(CScriptFile* aIniSettingsFile) :
	iIniSettingsFile(aIniSettingsFile)
	{
	iExpectedStatusCode=405;
	}

const TDesC& CHttpTestCasePost23::TestName()
	{
	_LIT(KHeaderTestName,"Iteration 2 Post Test 23 ");
	return KHeaderTestName;
	}

void CHttpTestCasePost23::OpenTestSessionL()
	{
	//open  a Session
	
	iSession.OpenL();
	iEngine->Utils().LogIt(_L("Session Created(Iteration 2 Post Test 23)"));
	...
	_LIT8(KWapTestUrl,	"http://WapTestIP/http_tests/rc/401/private/dumpform.pl");
...
void CHttpTestCasePost23::CloseTestSession()
	{
...
TBool CHttpTestCasePost23::GetCredentialsL(const TUriC8& aURI, RString aRealm, RStringF aAuthenticationType, RString& aUsername, RString& aPassword)
	{
...
void CHttpTestCasePost23::MHFRunL(RHTTPTransaction aTransaction,
								  THTTPEvent aEvent)
	{
