...
CHttpTestCase9::CHttpTestCase9(CScriptFile* aIniSettingsFile) : 
	CHttpTestTransBase(),
	iIniSettingsFile(aIniSettingsFile)
	{
	}

void CHttpTestCase9::DoRunL()
	{
...
TInt CHttpTestCase9::RunError(TInt aErr)
	{
	iEngine->Utils().LogIt(_L("\nTest failed with error code %d\n"), aErr);
	return KErrNone;
	}

void CHttpTestCase9::DoCancel()
	{
	}

CHttpTestCase9::~CHttpTestCase9()
	{
	}	
...
void CHttpTestCase9::CompleteOwnRequest()
	{
...
*/
const TDesC& CHttpTestCase9::TestName()
	{
	_LIT(KHeaderTestName,"Test Case 9 ");
	return KHeaderTestName;
	}


TInt CHttpTestCase9::MHFRunError(TInt aError, RHTTPTransaction /*aTransaction*/,
...
void CHttpTestCase9::CloseTestSession()
	{
