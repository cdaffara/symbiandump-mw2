...
#ifndef __ITER5Chunked2_H__
#define __ITER5Chunked2_H__
...
class CHttpTestCaseIter5Chunked2: public CHttpTestChunkedBase 
	{
public:
	CHttpTestCaseIter5Chunked2(CScriptFile* aIniSettingsFile);
