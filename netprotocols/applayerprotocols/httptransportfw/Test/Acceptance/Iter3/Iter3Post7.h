...
#ifndef __ITER3POST7_H__
#define __ITER3POST7_H__
...
class CHttpTestCaseIter3Post7: public CHttpTestChunkedBase 
	{
public:
	CHttpTestCaseIter3Post7(CScriptFile* aIniSettingsFile);
