...
#ifndef C_COMASUPLSESSION_H
#define C_COMASUPLSESSION_H
                        ...
                        public MOMASuplDialogTimeOutNotifier
{
  ...
  public:  // Constructors and destructor
	...
	public:  // Constructors and destructor        
			...
			* @since S60 v3.1u
			* @param aCommManager,communication manager for sending packet to SLP CSuplCommunicationManager 
			...
			* @return None
			*/
		    static COMASuplSession* NewL(CSuplCommunicationManager& aCommManager,
	...
	public: 			 
			...
			* @return      None
			*/
		  virtual void  RunSuplSessionL(TRequestStatus& aStatus, TBool aFirstReq,
		                                        const TDesC& aHslpAddress, TBool aFallBack,
		  										TInt aAllowedCapabilities,TInt aSessionIdSeed,
		  										TSuplTerminalQop& aQop, TInt aRequestID = 0);
										 
			/**
			* RunInvalidSessionL Method
			* @since S60 v3.1u
			* @param aSessionId, the invalid session Id received by COMASUPLProtocolManager1
			* @return None
			*/	 
	...
	public:
			...
			*/
			...
			virtual void CancelTriggerSession();
			/**
