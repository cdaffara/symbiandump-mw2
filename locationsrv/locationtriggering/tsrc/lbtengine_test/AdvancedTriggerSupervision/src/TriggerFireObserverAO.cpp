...
// INCLUDE FILES
#include "TriggerFireObserverAO.h"
            ...
            CActiveSchedulerWait* aWait,CLbtListTriggerOptions* aListOptions )   
{
    ...
    iWait=aWait;	
	aLbt.GetTriggers(aTriggerList,aListOptions,iStatus);
	SetActive( ); 
}
            ...
            CActiveSchedulerWait* aWait,CLbtListTriggerOptions* aListOptions)   
{
    ...
    iWait=aWait;	
	aLbt.ListTriggerIds(aTriggerIdList,aListOptions,iStatus);
	SetActive( ); 
}
            ...
            CActiveSchedulerWait* aWait,CLbtListTriggerOptions* aListOptions)   
{
    ...
    iWait=aWait;	
//	aLbt.CreateGetTriggerIteratorL(aListOptions,iStatus);
	SetActive( ); 
}
//  End of File
