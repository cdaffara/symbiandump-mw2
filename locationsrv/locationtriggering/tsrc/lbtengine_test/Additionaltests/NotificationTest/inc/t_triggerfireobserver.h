...
#include <lbttriggerchangeeventobserver.h>	
  ...
  class CTriggerFireObserver: public CTimer,MLbtTriggerFiringEventObserver,MLbtTriggerChangeEventObserver
    ...
    public:  // Constructors and destructor
       ...
       void ListTriggerIdsList(RLbt& aLbt, RArray < TLbtTriggerId >& aTriggerIdList,
        ...
        void NotifyTriggerChangeEventL( RLbt& aLbt,CActiveSchedulerWait* aWait )   ;
    ...
    private:
        ...
        CLbtTriggerChangeEventNotifier * trigchangenotifier;
