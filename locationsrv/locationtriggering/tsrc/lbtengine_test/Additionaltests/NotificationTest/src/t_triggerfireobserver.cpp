...
void CTriggerFireObserver::ConstructL( RLbt& aLbt )
    {
     	...
     	trigchangenotifier= CLbtTriggerChangeEventNotifier ::NewL( aLbt,*this );
...
void CTriggerFireObserver::NotifyTriggerChangeEventL( RLbt& aLbt,CActiveSchedulerWait* aWait )   
	{
		iWait = aWait;
		trigchangenotifier->Start();
	}
	
void CTriggerFireObserver::TriggerChangedL( const TLbtTriggerChangeEvent& /*aEvent*/ )
	{
	  // iEvent = aEvent;
