...
#if !defined(AFX_RecordSampleRate_H__73051B14_ADBF_4364_81DB_E438FDF6C607__INCLUDED_)
#define AFX_RecordSampleRate_H__73051B14_ADBF_4364_81DB_E438FDF6C607__INCLUDED_
...
class CRecordSampleRate  : CRecordingBase
{
public:
	CRecordSampleRate(CTestModuleIf *aConsole, CStifLogger *aLogger);
	virtual ~CRecordSampleRate();
...
//	TBool iFirstTime;
	TInt iCurrSampleRate;

};

#endif // !defined(AFX_RecordSampleRate_H__73051B14_ADBF_4364_81DB_E438FDF6C607__INCLUDED_)
