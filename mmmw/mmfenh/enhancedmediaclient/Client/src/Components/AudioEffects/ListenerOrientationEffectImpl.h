...
#ifndef LISTENERORIENTATIONEFFECTIMPL_H
#define LISTENERORIENTATIONEFFECTIMPL_H
...
namespace multimedia
    ...
    class CListenerOrientationEffect : public CBase,
                          public MListenerOrientationControl,
                          public MAudioEffectObserver,
                          public CEffectControlBase
        {
    public:
        CListenerOrientationEffect();
        ~CListenerOrientationEffect();
    ...
    private:
        CListenerOrientationProxy* iListenerOrientationProxy;
        CListenerOrientationProxy* iPrevListenerOrientationProxy;
...
#endif // LISTENERORIENTATIONEFFECTIMPL_H
