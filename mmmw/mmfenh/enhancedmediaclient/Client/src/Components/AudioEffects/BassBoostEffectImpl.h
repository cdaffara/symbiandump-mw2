...
#ifndef BASSBOOSTEFFECTIMPL_H
#define BASSBOOSTEFFECTIMPL_H
...
namespace multimedia
    ...
    class CBassBoostEffect : public CBase,
                          public MBassBoostControl,
    ...
    private:
        CBassBoostProxy* iBassBoostProxy;
        CBassBoostProxy* iPrevBassBoostProxy;
