...
class CSimpleMeta : public CSimpleBaseDocument, public MSimpleMeta
    {
...
public:
     ...
     * @return CSimpleMeta
     */
    static CSimpleMeta* NewL( const TDesC8& aXml );
