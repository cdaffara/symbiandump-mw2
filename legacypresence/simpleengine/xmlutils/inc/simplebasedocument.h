...
* Contributors:
*
* Description:   SIMPLE document base
*
*/
...
#ifndef simplebasedocument_H
#define simplebasedocument_H
 ...
 *  CSimpleBaseDocument
 *
 *  SIMPLE Engine document base class.
 *
 *  @lib simplexmlutils
 *  @since S60 v3.2
 */

class CSimpleBaseDocument : public CBase
    {
...
public:
     ...
     */
    virtual void ValidateXmlL( const TDesC8& aName ) = 0;
...
protected:
    ...
    /**
     * Two-phase constructor, for derived classes
     */
    void BaseConstructL(
        const TDesC8& aNsUri,
        const TDesC8& aLocalName );
    ...
    /**
     * Contructor for deriveed classes
     * @since S60 3.2     
...
private:    // data
     ...
     * Own.
     */
    CSimpleElement*     iRoot;

    /**
     * Extra namespaces
     */
    RPointerArray<CSimpleNamespace> iNsps;

    /**
     * Extra namespaces, M-classes
     */
    RPointerArray<MSimpleNamespace> iMNsps;
