...
#ifndef __T_MSGPERFSEARCHSORTUSINGQI_H__
#define __T_MSGPERFSEARCHSORTUSINGQI_H__
...
/* Literals Used */
_LIT(KPerfSearchSortUsingQI,"PerfSearchSortUsingQI");

/* 
 * Implements a test step  for getting the number of message entries satisfying a given serach-sort  criteria.
 */
class CT_MsgPerfSearchSortUsingQI : public CT_MsgAsyncStepCommon
	{
public:
	/* Creates an object of CT_MsgPerfSearchSortUsingQI */
	static CT_MsgPerfSearchSortUsingQI* NewL(CT_MsgSharedDataCommon& aSharedDataCommon);

	~CT_MsgPerfSearchSortUsingQI();
...
protected:
	void ConstructL();
private:
	CT_MsgPerfSearchSortUsingQI(CT_MsgSharedDataCommon& aSharedDataCommon);
