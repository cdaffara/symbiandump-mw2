...
CMtfTestAction* CMtfTestActionRemoveFileAttachmentById::NewL(CMtfTestCase& aTestCase,CMtfTestActionParameters* aActionParameters)
	{
	CMtfTestActionRemoveFileAttachmentById* self = new(ELeave) CMtfTestActionRemoveFileAttachmentById(aTestCase);
...
CMtfTestActionRemoveFileAttachmentById::CMtfTestActionRemoveFileAttachmentById(CMtfTestCase& aTestCase)
	: CMtfSynchronousTestAction(aTestCase)
	{
	}


CMtfTestActionRemoveFileAttachmentById::~CMtfTestActionRemoveFileAttachmentById()
	{
	}

void CMtfTestActionRemoveFileAttachmentById::ExecuteActionL()
	{
	TestCase().INFO_PRINTF2(_L("Test Action %S start..."), &KTestActionRemoveFileAttachmentById);
	TRAPD(err, RunTestL());
	...
	TestCase().INFO_PRINTF2(_L("Test Action %S completed."), &KTestActionRemoveFileAttachmentById);	
	TestCase().ActionCompletedL(*this); 
	}

void CMtfTestActionRemoveFileAttachmentById::RunTestL()
	{
