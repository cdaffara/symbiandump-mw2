...
#ifndef __T_PERFORMANCE421CLIENT_H__
#define __T_PERFORMANCE421CLIENT_H__
...
class CPerformance421Client : public CActive , public MMsvImapConnectionObserver
	{

public:
	
	static CPerformance421Client* NewL(CPerformanceStepBase& aStepBase);
	static CPerformance421Client* NewLC(CPerformanceStepBase& aStepBase);
	void StartL();
	~CPerformance421Client();
private:
	CPerformance421Client(CPerformanceStepBase& aStepBase);
	void ConstructL();
...
#endif  //__T_PERFORMANCE421CLIENT_H__
