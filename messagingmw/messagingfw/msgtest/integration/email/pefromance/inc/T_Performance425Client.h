...
#ifndef __T_PERFORMANCE425CLIENT_H__
#define __T_PERFORMANCE425CLIENT_H__
...
class CPerformance425Client : public CActive , public MMsvImapConnectionObserver
	{

public:
	
	static CPerformance425Client* NewL(CPerformanceStepBase& aStepBase);
	static CPerformance425Client* NewLC(CPerformanceStepBase& aStepBase);
	void StartL();
	~CPerformance425Client();

private:
	CPerformance425Client(CPerformanceStepBase& aStepBase);
	void ConstructL();
...
#endif  //__T_PERFORMANCE425CLIENT_H__
