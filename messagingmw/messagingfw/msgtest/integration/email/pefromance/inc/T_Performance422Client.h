...
#ifndef __T_PERFORMANCE422CLIENT_H__
#define __T_PERFORMANCE422CLIENT_H__
...
class CPerformance422Client : public CActive , public MMsvImapConnectionObserver
	{

public:
	
	static CPerformance422Client* NewL(CPerformanceStepBase& aStepBase);
	static CPerformance422Client* NewLC(CPerformanceStepBase& aStepBase);
	void StartL();
	~CPerformance422Client();

private:
	CPerformance422Client(CPerformanceStepBase& aStepBase);
	void ConstructL();
...
#endif  //__T_PERFORMANCE422CLIENT_H__
