...
#ifndef __T_PERFORMANCE428CLIENT_H__
#define __T_PERFORMANCE428CLIENT_H__
...
class CPerformance428Client : public CActive , public MMsvImapConnectionObserver
	{

public:
	
	static CPerformance428Client* NewL(CPerformanceStepBase& aStepBase);
	static CPerformance428Client* NewLC(CPerformanceStepBase& aStepBase);
	void StartL();
	~CPerformance428Client();
private:
	CPerformance428Client(CPerformanceStepBase& aStepBase);
	void ConstructL();
...
#endif  //__T_PERFORMANCE428CLIENT_H__
