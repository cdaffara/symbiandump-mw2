...
#ifndef __T_PERFORMANCE424CLIENT_H__
#define __T_PERFORMANCE424CLIENT_H__
...
class CPerformance424Client : public CActive , public MMsvImapConnectionObserver
	{

public:
	
	static CPerformance424Client* NewL(CPerformanceStepBase& aStepBase);
	static CPerformance424Client* NewLC(CPerformanceStepBase& aStepBase);
	void StartL();
	~CPerformance424Client();
private:
	CPerformance424Client(CPerformanceStepBase& aStepBase);
	void ConstructL();
...
#endif  //__T_PERFORMANCE424CLIENT_H__
