...
CPerformance422Step::~CPerformance422Step()
	{
	delete iImapClient;	
	}
...
CPerformance422Step::CPerformance422Step()
	...
	SetTestStepName(KPerformance422);
	iProfile=EFalse;
	}

TVerdict CPerformance422Step::doTestStepL()
	{
	//start the imap client
	iImapClient = CPerformance422Client::NewL(*this);
	iImapClient->StartL();
	//start the test
	if(iProfile)
		{
...
TVerdict CPerformance422Step::doTestStepPreambleL()
	{
