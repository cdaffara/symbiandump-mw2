...
_LIT(KAOManagerLogTag,                 "AOMStarter: ");
_LIT(KAOManagerLogTimeFormatString,    "%H:%T:%S:%*C2 ");

_LIT(KAOManagerLogMessageAppBanner,"AlwaysOnlineManager %d.%d.%d   (AOMStarter)");
_LIT(KAOManagerLogEnterFn,         "AOMStarter: -> %S");
_LIT(KAOManagerLogLeaveFn,         "AOMStarter: <- %S");
_LIT(KAOManagerLogWrite,           "AOMStarter: %S");
_LIT(KAOManagerLogExitBanner,      "AOMStarter exit");
...
#else
_LIT(KAOManagerLogDir,                 "AOMStarter");
_LIT(KAOManagerLogFile,                "AOMStarter.txt");
_LIT8(KAOManagerLogMessageAppBanner,      "AlwaysOnlineManager %d.%d.%d   (AOMStarter)");
_LIT8(KAOManagerLogEnterFn,               "-> %S");
_LIT8(KAOManagerLogLeaveFn,               "<- %S");
_LIT8(KAOManagerLogExit,                  "AOMStarter exit");
